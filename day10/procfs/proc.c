...
{
	/*_create()  - creates the entry in /proc
	 * PROC_NAME - name of the process
	 * 0666      - permissions for user, owner & group[leading 0 is to tell build system that its an octal]
	 * NULL      - used for proc_dir_entry
	 * &proc_file_ops - for particular proc entry created struct for proc file ops. 
	 * */
